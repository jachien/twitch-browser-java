                ...
                if (JsonPath.class == a.annotationType()) {
                    ...
                    try {
                        if (fieldType == int.class) {
                            f.set(ret, p.getAsInt());
                        } else if (fieldType == String.class) {
                            f.set(ret, p.getAsString());
                        } else {
                            throw new RuntimeException("unsupported type: " + fieldType + " for field " + f.getName());
                        }
                        //System.out.println("set " + f.getName() + " to " + f.get(ret));
